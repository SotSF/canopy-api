...
/* Provides an easy to use way to return JSON from the api. Just return a plain java class.
 * https://memorynotfound.com/jaxrs-jersey-gson-serializer-deserializer/
 */
